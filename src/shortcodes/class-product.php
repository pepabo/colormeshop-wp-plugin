...
class Product implements Shortcode_Interface {
	...
	private static function _id( $container, $filtered_atts, $content, $tag ) {
		return $container['model.product_api']->getProduct( $filtered_atts['product_id'] )['product']['id'];
	}
	...
	private static function _name( $container, $filtered_atts, $content, $tag ) {
		return $container['model.product_api']->getProduct( $filtered_atts['product_id'] )['product']['name'];
	}
	...
	private static function _model( $container, $filtered_atts, $content, $tag ) {
		return $container['model.product_api']->getProduct( $filtered_atts['product_id'] )['product']['model_number'];
	}
	...
	private static function _price( $container, $filtered_atts, $content, $tag ) {
		return self::number_format( $container['model.product_api']->getProduct( $filtered_atts['product_id'] )['product']['price'] );
	}
	...
	private static function _regular_price( $container, $filtered_atts, $content, $tag ) {
		return self::number_format( $container['model.product_api']->getProduct( $filtered_atts['product_id'] )['product']['sales_price'] );
	}
	...
	private static function _members_price( $container, $filtered_atts, $content, $tag ) {
		return self::number_format( $container['model.product_api']->getProduct( $filtered_atts['product_id'] )['product']['members_price'] );
	}
	...
	private static function _unit( $container, $filtered_atts, $content, $tag ) {
		return $container['model.product_api']->getProduct( $filtered_atts['product_id'] )['product']['unit'];
	}
	...
	private static function _weight( $container, $filtered_atts, $content, $tag ) {
		return $container['model.product_api']->getProduct( $filtered_atts['product_id'] )['product']['weight'];
	}
	...
	private static function _simple_explain( $container, $filtered_atts, $content, $tag ) {
		return $container['model.product_api']->getProduct( $filtered_atts['product_id'] )['product']['simple_expl'];
	}
	...
	private static function _explain( $container, $filtered_atts, $content, $tag ) {
		$p = $container['model.product_api']->getProduct( $filtered_atts['product_id'] )['product'];
	...
	private static function _postage( $container, $filtered_atts, $content, $tag ) {
		return $container['model.product_api']->getProduct( $filtered_atts['product_id'] )['product']['delivery_charge'];
	}
