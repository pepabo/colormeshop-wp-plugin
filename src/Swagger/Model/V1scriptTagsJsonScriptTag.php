...
/**
 * V1scriptTagsJsonScriptTag Class Doc Comment
 *
 * @category Class
 * @package  ColorMeShop\Swagger
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1scriptTagsJsonScriptTag implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1script_tags.json_script_tag';
    ...
    const DISPLAY_SCOPE_SHOP = 'shop';
    const DISPLAY_SCOPE_THANKS_PAGE = 'thanks_page';
     ...
     * @return string[]
     */
    public function getDisplayScopeAllowableValues()
    {
        return [
            self::DISPLAY_SCOPE_ALL,
            self::DISPLAY_SCOPE_SHOP,
            self::DISPLAY_SCOPE_THANKS_PAGE,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['display_scope'] = isset($data['display_scope']) ? $data['display_scope'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getDisplayScopeAllowableValues();
        if (!in_array($this->container['display_scope'], $allowedValues)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'display_scope', must be one of '%s'",
    ...
    {
        return $this->container['display_scope'];
    }

    /**
     * Sets display_scope
     *
     * @param string $display_scope スクリプトを出力するページ。  - `all`: ショップページと注文完了ページの両方 - `shop`: ショップページ - `thanks_page`: 注文完了ページ
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getDisplayScopeAllowableValues();
        if (!is_null($display_scope) && !in_array($display_scope, $allowedValues)) {
        ...
        $this->container['display_scope'] = $display_scope;
