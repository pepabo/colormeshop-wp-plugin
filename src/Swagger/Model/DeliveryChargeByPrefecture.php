 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class DeliveryChargeByPrefecture implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['pref_id']) && ($this->container['pref_id'] > 48)) {
            $invalid_properties[] = "invalid value for 'pref_id', must be smaller than or equal to 48.";
        }

        if (!is_null($this->container['pref_id']) && ($this->container['pref_id'] < 1)) {
            $invalid_properties[] = "invalid value for 'pref_id', must be bigger than or equal to 1.";
        }
