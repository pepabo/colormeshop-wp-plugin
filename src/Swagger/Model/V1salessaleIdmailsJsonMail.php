...
/**
 * V1salessaleIdmailsJsonMail Class Doc Comment
 *
 * @category Class
 * @package  ColorMeShop\Swagger
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1salessaleIdmailsJsonMail implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1salessaleIdmails.json_mail';
     ...
     * Sets type
     *
     * @param string $type 送信するメールの種類  - `accepted`: 受注メールを送信する - `paid`: 入金確認メールを送信する - `delivered`: 商品発送メールを送信する
     *
     * @return $this
     */
