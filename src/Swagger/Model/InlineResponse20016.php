...
class InlineResponse20016 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'script_tags' => '\ColorMeShop\Swagger\Model\ScriptTag[]'
    ];
    ...
    {
        $this->container['script_tags'] = isset($data['script_tags']) ? $data['script_tags'] : null;
    }
    ...
    {
        return $this->container['script_tags'];
    }

    /**
     * Sets script_tags
     *
     * @param \ColorMeShop\Swagger\Model\ScriptTag[] $script_tags script_tags
     *
     * @return $this
     */
    public function setScriptTags($script_tags)
    {
        $this->container['script_tags'] = $script_tags;
