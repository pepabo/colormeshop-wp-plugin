 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1salessaleIdJsonSale implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = $this->getPointStateAllowableValues();
        if (!in_array($this->container['point_state'], $allowed_values)) {
    ...
    {
        $allowed_values = $this->getPointStateAllowableValues();
        if (!is_null($point_state) && !in_array($point_state, $allowed_values)) {
     ...
     * @param \ColorMeShop\Swagger\Model\SaleDelivery[] $sale_deliveries
     * @return $this
     */
