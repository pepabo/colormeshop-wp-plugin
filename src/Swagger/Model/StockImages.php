 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class StockImages implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Stock_images';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['position']) && ($this->container['position'] > 3)) {
            $invalidProperties[] = "invalid value for 'position', must be smaller than or equal to 3.";
        }
    ...
    public function setPosition($position)
    {
        ...
        if (!is_null($position) && ($position > 3)) {
            throw new \InvalidArgumentException('invalid value for $position when calling StockImages., must be smaller than or equal to 3.');
        }
        if (!is_null($position) && ($position < 1)) {
            throw new \InvalidArgumentException('invalid value for $position when calling StockImages., must be bigger than or equal to 1.');
        }
