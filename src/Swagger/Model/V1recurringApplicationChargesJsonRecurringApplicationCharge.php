<?php
/**
 * V1recurringApplicationChargesJsonRecurringApplicationCharge
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * V1recurringApplicationChargesJsonRecurringApplicationCharge Class Doc Comment
 *
 * @category Class
 * @package  ColorMeShop\Swagger
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1recurringApplicationChargesJsonRecurringApplicationCharge implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1recurring_application_charges.json_recurring_application_charge';
