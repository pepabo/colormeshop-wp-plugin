...
/**
 * SaleCreateRequestSale Class Doc Comment
 *
 * @category Class
 * @package  ColorMeShop\Swagger
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SaleCreateRequestSale implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'saleCreateRequest_sale';
    ...
    protected static $swaggerTypes = [
        'customer' => '\ColorMeShop\Swagger\Model\SaleCreateRequestSaleCustomer',
'sale_deliveries' => '\ColorMeShop\Swagger\Model\SaleCreateRequestSaleSaleDeliveries[]',
'details' => '\ColorMeShop\Swagger\Model\SaleCreateRequestSaleDetails[]',
'payment_id' => 'int',
...
'external_order_id' => 'getExternalOrderId'    ];
     ...
     * Gets customer
     *
     * @return \ColorMeShop\Swagger\Model\SaleCreateRequestSaleCustomer
     */
     ...
     * Sets customer
     *
     * @param \ColorMeShop\Swagger\Model\SaleCreateRequestSaleCustomer $customer customer
     *
     * @return $this
     */
     ...
     *
     * @return \ColorMeShop\Swagger\Model\SaleCreateRequestSaleSaleDeliveries[]
     */
     ...
     *
     * @param \ColorMeShop\Swagger\Model\SaleCreateRequestSaleSaleDeliveries[] $sale_deliveries 配送不要商品を含む場合、Square連携用決済の場合を除き必須です。
     *
     * @return $this
     */
     ...
     * Gets details
     *
     * @return \ColorMeShop\Swagger\Model\SaleCreateRequestSaleDetails[]
     */
     ...
     * Sets details
     *
     * @param \ColorMeShop\Swagger\Model\SaleCreateRequestSaleDetails[] $details details
     *
     * @return $this
     */
     ...
     * Sets payment_id
     *
     * @param int $payment_id 使用された決済方法ID  非表示の決済方法も使用できます。
     *
     * @return $this
     */
     ...
     *
     * @param string $external_order_id 外部システムで発行された決済識別番号  Square連携の際に、Square Point of Sale APIで発行された決済識別番号（orderID）を渡します。  将来的に似たような形で外部システムの決済識別番号を渡す際にはこのパラメータを使用することを想定しています。
     *
     * @return $this
     */
