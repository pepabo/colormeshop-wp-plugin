<?php
/**
 * V1productsproductIdProductVariants
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * V1productsproductIdProductVariants Class Doc Comment
 *
 * @category Class
 * @package  ColorMeShop\Swagger
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1productsproductIdProductVariants implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1productsproduct_id_product_variants';
...
'stocks' => 'OneOfv1productsproductIdProductVariantsStocks'    ];
...
'stocks' => 'getStocks'    ];
     ...
     * Gets stocks
     *
     * @return OneOfv1productsproductIdProductVariantsStocks
     */
     ...
     * Sets stocks
     *
     * @param OneOfv1productsproductIdProductVariantsStocks $stocks 上記`stocks`と同様に、数値、または増減値を用いて在庫数を更新できます。
     *
     * @return $this
     */
