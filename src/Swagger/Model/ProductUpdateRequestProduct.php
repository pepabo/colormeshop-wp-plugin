 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ProductUpdateRequestProduct implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['cost']) && ($this->container['cost'] < 0)) {
            $invalid_properties[] = "invalid value for 'cost', must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['sales_price']) && ($this->container['sales_price'] < 0)) {
            $invalid_properties[] = "invalid value for 'sales_price', must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['members_price']) && ($this->container['members_price'] < 0)) {
            $invalid_properties[] = "invalid value for 'members_price', must be bigger than or equal to 0.";
        }
        ...
        if (!is_null($this->container['simple_expl']) && (strlen($this->container['simple_expl']) > 255)) {
            $invalid_properties[] = "invalid value for 'simple_expl', the character length must be smaller than or equal to 255.";
        }
