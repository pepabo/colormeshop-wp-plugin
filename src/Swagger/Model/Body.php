...
class Body implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['order_num']) && ($this->container['order_num'] < 0)) {
            $invalidProperties[] = "invalid value for 'order_num', must be bigger than or equal to 0.";
        }
    ...
    public function setOrderNum($order_num)
    {
        ...
        if (!is_null($order_num) && ($order_num < 0)) {
            throw new \InvalidArgumentException('invalid value for $order_num when calling Body., must be bigger than or equal to 0.');
        }
