...
/**
 * V1customersCustomer Class Doc Comment
 *
 * @category Class
 * @package  ColorMeShop\Swagger
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1customersCustomer implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1customers_customer';
...
'add_member' => 'getAddMember'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['add_member'] = isset($data['add_member']) ? $data['add_member'] : null;
    }
     ...
     * Sets address2
     *
     * @param string $address2 住所（建物名など）
     *
     * @return $this
     */
    ...
    {
        return $this->container['add_member'];
    }

    /**
     * Sets add_member
     *
     * @param bool $add_member 会員登録をするか否か
     *
     * @return $this
     */
    public function setAddMember($add_member)
    {
        $this->container['add_member'] = $add_member;
