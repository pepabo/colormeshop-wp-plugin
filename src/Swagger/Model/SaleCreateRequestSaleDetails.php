...
/**
 * SaleCreateRequestSaleDetails Class Doc Comment
 *
 * @category Class
 * @package  ColorMeShop\Swagger
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SaleCreateRequestSaleDetails implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'saleCreateRequest_sale_details';
...
'price' => 'getPrice'    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['product_num'] === null) {
            $invalidProperties[] = "'product_num' can't be null";
        }
     ...
     * Sets product_id
     *
     * @param int $product_id 商品ID  非掲載の商品も受注できます。
     *
     * @return $this
     */
     ...
     * Sets option1_value
     *
     * @param string $option1_value 商品オプション1の値
     *
     * @return $this
     */
     ...
     * Sets option2_value
     *
     * @param string $option2_value 商品オプション2の値
     *
     * @return $this
     */
     ...
     * Sets price
     *
     * @param int $price 価格を指定して受注を作成できます。  ショップの消費税設定が外税なら税抜価格、内税なら税込価格を指定します。  指定しない場合、カラーミーショップの商品価格が適用されます。
     *
     * @return $this
     */
