...
class EtcApi
{
    ...
    {
        $this->deleteDeviceTokenWithHttpInfo($token);
    }
     ...
     */
    public function deleteDeviceTokenWithHttpInfo($token)
    {
        $returnType = '';
        $request = $this->deleteDeviceTokenRequest($token);
    ...
    /**
     * Operation deleteDeviceTokenAsync
     *
     * デバイストークンの削除
     *
     * @param  string $token (required)
     ...
     */
    public function deleteDeviceTokenAsync($token)
    {
        return $this->deleteDeviceTokenAsyncWithHttpInfo($token)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteDeviceTokenAsyncWithHttpInfo
     *
     * デバイストークンの削除
     *
     * @param  string $token (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteDeviceTokenAsyncWithHttpInfo($token)
    {
        $returnType = '';
        $request = $this->deleteDeviceTokenRequest($token);
    ...
    /**
     * Create request for operation 'deleteDeviceToken'
     *
     * @param  string $token (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function deleteDeviceTokenRequest($token)
    {
        // verify the required parameter 'token' is set
        if ($token === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $token when calling deleteDeviceToken'
            );
        }

        $resourcePath = '/v1/device_tokens/{token}.json';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
