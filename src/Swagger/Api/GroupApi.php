...
class GroupApi
{
    ...
    {
        list($response) = $this->getProductGroupsWithHttpInfo();
        return $response;
    }
     ...
     */
    public function getProductGroupsAsync()
    {
        return $this->getProductGroupsAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function getProductGroupsRequest()
    {
