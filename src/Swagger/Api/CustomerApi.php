...
class CustomerApi
{
    ...
    public function getCustomerWithHttpInfo($customer_id)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\ColorMeShop\Swagger\Model\InlineResponse2005', $e->getResponseHeaders());
    ...
    public function getCustomersWithHttpInfo($ids = null, $name = null, $furigana = null, $mail = null, $postal = null, $tel = null, $mobile = null, $make_date_min = null, $make_date_max = null, $update_date_min = null, $update_date_max = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\ColorMeShop\Swagger\Model\InlineResponse2004', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
            throw $e;
