...
class GiftApi
{
    ...
    {
        list($response) = $this->getGiftWithHttpInfo();
        return $response;
    }
     ...
     */
    public function getGiftAsync()
    {
        return $this->getGiftAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getGiftAsyncWithHttpInfo
     *
     * ギフト設定を取得
     *
     *
    ...
    /**
     * Create request for operation 'getGift'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getGiftRequest()
    {

        $resourcePath = '/v1/gift.json';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
