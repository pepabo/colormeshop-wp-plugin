...
class CategoryApi
{
    ...
    {
        list($response) = $this->getProductCategoriesWithHttpInfo();
        return $response;
    }
     ...
     */
    public function getProductCategoriesWithHttpInfo()
    {
        $returnType = '\ColorMeShop\Swagger\Model\InlineResponse20011';
        $request = $this->getProductCategoriesRequest();
     ...
     */
    public function getProductCategoriesAsync()
    {
        return $this->getProductCategoriesAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProductCategoriesAsyncWithHttpInfo()
    {
        $returnType = '\ColorMeShop\Swagger\Model\InlineResponse20011';
        $request = $this->getProductCategoriesRequest();
     ...
     */
    protected function getProductCategoriesRequest()
    {

        $resourcePath = '/v1/categories.json';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
