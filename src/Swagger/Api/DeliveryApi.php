...
class DeliveryApi
{
    ...
    {
        list($response) = $this->getDeliveriesWithHttpInfo();
        return $response;
    }
     ...
     */
    public function getDeliveriesAsync()
    {
        return $this->getDeliveriesAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getDeliveriesAsyncWithHttpInfo
     *
     * 配送方法一覧を取得
     *
     *
    ...
    /**
     * Create request for operation 'getDeliveries'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getDeliveriesRequest()
    {

        $resourcePath = '/v1/deliveries.json';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getDeliveryDateSetting
     *
     * 配送日時設定を取得
     *
     *
    ...
    {
        list($response) = $this->getDeliveryDateSettingWithHttpInfo();
        return $response;
    }

    /**
     * Operation getDeliveryDateSettingWithHttpInfo
     *
     * 配送日時設定を取得
     *
     *
    ...
    /**
     * Operation getDeliveryDateSettingAsync
     *
     * 配送日時設定を取得
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDeliveryDateSettingAsync()
    {
        return $this->getDeliveryDateSettingAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getDeliveryDateSettingAsyncWithHttpInfo
     *
     * 配送日時設定を取得
     *
     *
    ...
    /**
     * Create request for operation 'getDeliveryDateSetting'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getDeliveryDateSettingRequest()
    {

        $resourcePath = '/v1/deliveries/date.json';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
