...
class DeliveryApi
{
    ...
    public function getDeliveriesWithHttpInfo()
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\ColorMeShop\Swagger\Model\InlineResponse20012', $e->getResponseHeaders());
    ...
    public function getDeliveryDateSettingWithHttpInfo()
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\ColorMeShop\Swagger\Model\InlineResponse20013', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
            throw $e;
