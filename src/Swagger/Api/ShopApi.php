...
class ShopApi
{
     ...
     * @return \ColorMeShop\Swagger\Model\InlineResponse200
     */
     ...
     * @throws \ColorMeShop\Swagger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ColorMeShop\Swagger\Model\InlineResponse200, HTTP status code, HTTP response headers (array of strings)
     */
    public function getShopWithHttpInfo()
    {

        $resourcePath = '/v1/shop.json';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        $multipart = false;
        $returnType = '\ColorMeShop\Swagger\Model\InlineResponse200';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\ColorMeShop\Swagger\Model\InlineResponse200', $e->getResponseHeaders());
